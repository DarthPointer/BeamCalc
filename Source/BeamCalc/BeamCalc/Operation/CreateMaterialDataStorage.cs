...
{
    class CreateMaterialDataStorage : AbstractParametrisedOperation
    {
        private bool ignoreSave;
        private bool ignoreOverwrite;


        public CreateMaterialDataStorage()
        {
        ...
        public override bool Execute(List<string> args)
        {
            ...
            if (!MandatoryArgumentPresense(args, "new material data storage path")) return true;
        ...
        public override string BasicHelpResponse => 
            $"Creates new material storage file with specified file path and swithces to editing it.\n" +
            $"\n" +
            $"Usage:\n" +
            $"CreateMaterialDataStorage filepath [params].\n" +
            $"\n" +
            $"Parameters:\n" +
